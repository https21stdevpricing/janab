          ...
          <div className="rounded-md border border-border/60 p-2 space-y-2">
            ...
            <div className="grid gap-2 sm:grid-cols-[1fr_auto_auto]">
              ...
              <select
                ...
                onChange={(e) => updateDesign({ ...design, watermarkLayer: e.target.value as any })}
              >
            ...
            <div className="grid gap-2 sm:grid-cols-[1fr_auto_auto]">
              <label className="h-8 rounded-md border bg-background px-2 text-xs flex items-center justify-between gap-2 cursor-pointer">
                <span className="truncate">
                  {design.watermarkLogoDataUrl ? "Logo watermark uploaded" : "Logo watermark (PNG)"}
                </span>
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              ...
              <label className="flex flex-col gap-1">
                ...
                <select
                  ...
                  onChange={(e) => updateDesign({ ...design, barcodeMode: e.target.value as any })}
                >
                ...
                {design.showShipTo && (
                  <label className="sm:col-span-2 flex flex-col gap-1">
                    ...
                    <textarea
                      ...
                      onChange={(e) => updateDesign({ ...design, shipToOverride: e.target.value })}
                    />
                  </label>
                )}
                  ...
                  <>
                    <label className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        onChange={(e) => updateDesign({ ...design, dispatchDocNo: e.target.value })}
                      />
                    </label>
                    <label className="flex flex-col gap-1">
                      <span className="text-[10px] uppercase tracking-wide text-muted-foreground">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 border border-slate-200 rounded p-3 text-[11px]">
                ...
                {design.transporter && (
                  <div>
                    ...
                    <div className="font-semibold text-[#111621] mt-0.5">{design.transporter}</div>
                  </div>
                )}
                {design.vehicleNo && (
                  <div>
                ...
                {design.destination && (
                  <div>
                    ...
                    <div className="font-semibold text-[#111621] mt-0.5">{design.destination}</div>
                  </div>
                )}
              </div>
            </section>
                    ...
                    <div className="mt-1 grid grid-cols-[auto_1fr] gap-x-3 gap-y-0.5 text-[11px]">
                      ...
                      {company?.bank_account_no && (
                        <>
                          ...
                          <span className="font-mono font-semibold">{company.bank_account_no}</span>
                        </>
                      )}
                      {company?.bank_ifsc && (
                        <>
            ...
            <div className="mt-6 break-inside-avoid">
              ...
              {design.showTaxInWords && totals.gst > 0 && (
                <p className="mt-2 text-[10.5px] text-[#374050]">
                  ...
                  <span className="font-semibold text-[#111621]">{amountInWords(totals.gst)}</span>
                </p>
              )}
            </div>
          )}
